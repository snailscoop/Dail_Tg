...
var SECP256K1_MULTICODEC_IDENTIFIER = 0xe7;
...
var getKeyPairFromPrivateKeyJwk = function getKeyPairFromPrivateKeyJwk(privateKeyJwk) {
  var privateKeyHex = Buffer.from(privateKeyJwk.d, 'base64').toString('hex');
...
var fromEcdsaSecp256k1VerificationKey2019 = function fromEcdsaSecp256k1VerificationKey2019(k) {
  return {
    publicKey: base58.decode(k.publicKeyBase58),
    privateKey: k.privateKeyBase58 ? base58.decode(k.privateKeyBase58) : undefined
  };
};
var fromEcdsaSecp256k1VerificationKey2020 = function fromEcdsaSecp256k1VerificationKey2020(_k) {
  throw new Error('EcdsaSecp256k1VerificationKey2020 cannot be imported becuase it does not support private keys.');
};
var importableTypes = {
...
var toJsonWebKey2020 = function toJsonWebKey2020(id, controller, publicKey, privateKey, alg) {
  // assume 0x04
...
var toEcdsaSecp256k1VerificationKey2019 = function toEcdsaSecp256k1VerificationKey2019(id, controller, publicKey, privateKey) {
  var k = {
    id: id,
...
var toEcdsaSecp256k1VerificationKey2020 = function toEcdsaSecp256k1VerificationKey2020(id, controller, publicKey, privateKey) {
  var k = {
    id: id,
  ...
  if (privateKey) {
    throw new Error('Unable to represent secp256k1 private key in multibase. See https://github.com/multiformats/multicodec/pull/210');
  }
  ...
  return {
    sign: function sign(_ref) {
      return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        var data, messageHashUInt8Array, sigObj;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                sigObj = secp256k1.ecdsaSign(messageHashUInt8Array, new Uint8Array(privateKey));
                return _context.abrupt("return", sigObj.signature);
...
var signer$1 = function signer(privateKey) {
  return {
    sign: function sign(_ref) {
      return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        var data, messageHashUInt8Array, _secp256k1$ecdsaSign, signature, recid;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                data = _ref.data;
                messageHashUInt8Array = crypto.createHash('sha256').update(data).digest();
                _secp256k1$ecdsaSign = secp256k1.ecdsaSign(messageHashUInt8Array, privateKey), signature = _secp256k1$ecdsaSign.signature, recid = _secp256k1$ecdsaSign.recid;
                return _context.abrupt("return", Uint8Array.from(Buffer.concat([Buffer.from(signature), Buffer.from(new Uint8Array([recid]))])));
...
var verifier$1 = function verifier(publicKey) {
  return {
    verify: function verify(_ref2) {
      return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
        var data, signature, digest, verified, recoveredPublicKey;
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                verified = false;
                recoveredPublicKey = secp256k1.ecdsaRecover(signature.slice(0, 64), signature[64], digest);

                try {
                  verified = Buffer.from(publicKey).toString('hex') === Buffer.from(recoveredPublicKey).toString('hex');
                } catch (e) {
...
var signer$2 = function signer(privateKey) {
  return {
    sign: function sign(_ref) {
      return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        var data, instance, digest;
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 3:
                ...
                digest = crypto.createHash('sha256').update(data).digest();
                return _context.abrupt("return", instance.signMessageHashSchnorr(privateKey, digest));
...
var verifier$2 = function verifier(publicKey) {
  return {
    verify: function verify(_ref2) {
      return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
        var data, signature, instance, digest, verified;
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
              ...
              case 3:
                ...
                try {
                  verified = instance.verifySignatureSchnorr(signature, publicKey, digest);
                } catch (e) {
                  console.error('An error occurred when verifying signature: ', e);
                }
...
var _generate = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(secureRandom) {
...
exports.Secp256k1KeyPair = Secp256k1KeyPair_1 = /*#__PURE__*/function () {
  ...
  Secp256k1KeyPair.fromFingerprint = /*#__PURE__*/function () {
    var _fromFingerprint = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(_ref2) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              if (!(buffer[0] === SECP256K1_MULTICODEC_IDENTIFIER && buffer[1] === VARIABLE_INTEGER_TRAILING_BYTE)) {
                _context2.next = 12;
                break;
              }

              _context2.next = 5;
              return Secp256k1KeyPair_1.from({
                id: '',
                controller: '',
                type: 'EcdsaSecp256k1VerificationKey2019',
  ...
  Secp256k1KeyPair.fingerprintFromPublicKey = /*#__PURE__*/function () {
    var _fingerprintFromPublicKey = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(importableType) {
      var _yield$Secp256k1KeyPa, publicKey;
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return Secp256k1KeyPair_1.from(importableType);

            case 2:
              _yield$Secp256k1KeyPa = _context3.sent;
              publicKey = _yield$Secp256k1KeyPa.publicKey;
              return _context3.abrupt("return", getMultibaseFingerprintFromPublicKeyBytes(publicKey));
    ...
    function fingerprintFromPublicKey(_x3) {
  ...
  _proto.deriveSecret = /*#__PURE__*/function () {
    var _deriveSecret = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(_ref3) {
      var publicKey, remote;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return Secp256k1KeyPair_1.from(publicKey);

            case 3:
              remote = _context5.sent;
              return _context5.abrupt("return", secp256k1.ecdh(remote.publicKey, this.privateKey));
  ...
  _proto["export"] = /*#__PURE__*/function () {
    var _export2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(options) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _context6.abrupt("return", exportableTypes[options.type](this.id, this.controller, this.publicKey, options.privateKey ? this.privateKey : undefined, this.alg));
...
exports.Secp256k1KeyPair.generate = /*#__PURE__*/function () {
  var _ref5 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(_ref4) {
    var secureRandom, alg, _yield$_generate, publicKey, privateKey, fingerprint, controller, id;

    return runtime_1.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            secureRandom = _ref4.secureRandom, alg = _ref4.alg;
            _context7.next = 3;
            return _generate(secureRandom);

          case 3:
            _yield$_generate = _context7.sent;
            publicKey = _yield$_generate.publicKey;
            privateKey = _yield$_generate.privateKey;
            fingerprint = getMultibaseFingerprintFromPublicKeyBytes(publicKey);
            controller = "did:key:" + fingerprint;
            id = controller + "#" + fingerprint;
            return _context7.abrupt("return", new Secp256k1KeyPair_1({
              id: id,
              type: 'JsonWebKey2020',
              controller: controller,
              publicKey: publicKey,
...
exports.Secp256k1KeyPair.from = /*#__PURE__*/function () {
  var _ref6 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(k) {
    var _k$publicKeyJwk;

    var _importableTypes$k$ty, publicKey, privateKey, secp256k1KeyPair;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            secp256k1KeyPair = new Secp256k1KeyPair_1({
              id: k.id,
              type: k.type,
            ...
            if ((_k$publicKeyJwk = k.publicKeyJwk) != null && _k$publicKeyJwk.alg) {
              secp256k1KeyPair.alg = k.publicKeyJwk.alg;
            }

            return _context8.abrupt("return", secp256k1KeyPair);
...
exports.Secp256k1KeyPair = Secp256k1KeyPair_1 = /*#__PURE__*/tslib.__decorate([/*#__PURE__*/ldKeyPair.staticImplements()], exports.Secp256k1KeyPair);
//# sourceMappingURL=secp256k1-key-pair.cjs.development.js.map
